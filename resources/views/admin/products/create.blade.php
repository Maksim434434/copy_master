            ...
            <div class="container mx-auto px-6 py-8">
                <div class="max-w-4xl mx-auto">
                    <div class="flex justify-between items-center mb-8">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-800">Добавить товар</h1>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category" 
                                        ...
                                        <option value="Смартфоны" {{ old('category') == 'Смартфоны' ? 'selected' : '' }}>Смартфоны</option>
                                        <option value="Ноутбуки" {{ old('category') == 'Ноутбуки' ? 'selected' : '' }}>Ноутбуки</option>
                                        <option value="Телевизоры" {{ old('category') == 'Телевизоры' ? 'selected' : '' }}>Телевизоры</option>
                                        <option value="Планшеты" {{ old('category') == 'Планшеты' ? 'selected' : '' }}>Планшеты</option>
                                        <option value="Наушники" {{ old('category') == 'Наушники' ? 'selected' : '' }}>Наушники</option>
                                        <option value="Фотоаппараты" {{ old('category') == 'Фотоаппараты' ? 'selected' : '' }}>Фотоаппараты</option>
                                        <option value="Игровые консоли" {{ old('category') == 'Игровые консоли' ? 'selected' : '' }}>Игровые консоли</option>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="description" id="description" rows="4"
                                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
