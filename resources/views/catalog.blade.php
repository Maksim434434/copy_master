@guest
    <x-layout title="Доступ запрещен">
        <x-section title="Требуется авторизация">
            <div class="container mx-auto px-4 py-16 text-center">
                <div class="max-w-md mx-auto">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Доступ ограничен</h2>
                    <p class="text-gray-600 mb-6">Для просмотра каталога необходимо авторизоваться в системе.</p>
